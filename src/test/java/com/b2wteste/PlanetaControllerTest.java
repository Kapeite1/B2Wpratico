...
import com.b2wteste.model.PlanetaExterno;
...
public class PlanetaControllerTest {
	...
	public void getPlanetaById() throws Exception {
		...
		mockMvc
			.perform(request)
			.andExpect(MockMvcResultMatchers.jsonPath("$.nome").value(planeta1.getNome()))
	...
	void successfullyCreateAPlaneta() throws Exception{
	    ...
	    ResultActions result = mockMvc.perform(MockMvcRequestBuilders.post("/planetas")
